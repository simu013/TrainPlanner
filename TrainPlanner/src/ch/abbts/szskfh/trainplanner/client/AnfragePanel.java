...
class AnfragePanel extends JPanel {
    ...
    private void addTopPanel() {
        ...
        //Farbe wird aus der Einstellungsklasse gelesen
        anfragePanel.setBackground(Color.decode(Einstellungen.getProperty("FrameFarbe")));
        ...
        //Farbe wird aus der Einstellungsklasse gelesen
        ankunftPanel.setBackground(Color.decode(Einstellungen.getProperty("FrameFarbe")));
        ...
        //Farbe wird aus der Einstellungsklasse gelesen
        buttonPanel.setBackground(Color.decode(Einstellungen.getProperty("FrameFarbe")));
